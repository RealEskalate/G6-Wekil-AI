...
mixin LocalesData {
  ...
  static const String Choose_the_type_of_contract_you_want_to_create = 'Choose_the_type_of_contract_you_want_to_create';
  static const String Service_Agreement = 'Service_Agreement';
  static const String Freelance_work_design_photography_consulting = 'Freelance_work_design_photography_consulting';
  static const String Sale_of_Goods = 'Sale_of_Goods';
  static const String Small_item_sales_product_delivery_terms = 'Small_item_sales_product_delivery_terms';
  static const String Simple_Loan_IOU = 'Simple_Loan_(IOU)';
  static const String Personal_loans_with_repayment_schedule = 'Personal_loans_with_repayment_schedule';
  static const String Basic_NDA = 'Basic_NDA';
  static const String Simple_confidentiality_agreement = 'Simple_confidentiality_agreement';

  static const String Not_for_Complex_Agreements = 'Not_for_Complex_Agreements';
  static const String This_tool_is_designed_for_basic_agreements_only_Please_consult_a_lawyer_for = 'This_tool_is_designed_for_basic_agreements_only_Please_consult_a_lawyer_for';
  static const String Employment_contracts = 'Employment_contracts';
  static const String Real_estate_or_land_transfers = 'Real_estate_or_land_transfers';
  static const String Corporate_or_shareholder_agreements = 'Corporate_or_shareholder_agreements';
  static const String Government_tenders_or_regulated_industries = 'Government_tenders_or_regulated_industries';
  ...
  static const String Describe_your_goods_delivery_terms = 'Describe_your_goods_delivery_terms';
  static const String Quick_Description_Optional = 'Quick_Description_Optional';

  static const String eg_Logo_design_5000_birr_2_weeks = 'eg_Logo_design_5000_birr_2_weeks';
  static const String eg_100_items_delivery_in_3_days = 'eg_100_items_delivery_in_3_days';
  static const String Optional_description_of_the_deal = 'Optional_description_of_the_deal';
  static const String This_information_helps_us_pre_fill_your_contract = 'This_information_helps_us_pre-fill_your_contract';
  ...
  static const Map<String, String> EN = {
    ...
    Choose_the_type_of_contract_you_want_to_create: 'Choose the type of contract you want to create',
    Service_Agreement: 'Service Agreement',
    Freelance_work_design_photography_consulting: 'Freelance work, design, photography, consulting',
    Sale_of_Goods: 'Sale of Goods',
    Small_item_sales_product_delivery_terms:'Small item sales, product delivery terms',
    Simple_Loan_IOU:'Simple Loan (IOU)',
    Personal_loans_with_repayment_schedule:'Personal loans with repayment schedule',
    Basic_NDA:'Basic NDA',

    Simple_confidentiality_agreement:'Simple confidentiality agreement',
    Not_for_Complex_Agreements:'Not for Complex Agreements',
    This_tool_is_designed_for_basic_agreements_only_Please_consult_a_lawyer_for:'This tool is designed for basic agreements only. Please consult a lawyer for',
    ...
    Government_tenders_or_regulated_industries:'Government tenders or regulated industries',
    ...
    This_information_helps_us_pre_fill_your_contract:'This information helps us pre-fill your contract.',
  ...
  static const Map<String, String> AM = {
    ...
    Freelance_work_design_photography_consulting: 'ነጻ ስራ, ንድፍ, ፎቶግራፊ, ምክር አገልግሎት',
    ...
    This_tool_is_designed_for_basic_agreements_only_Please_consult_a_lawyer_for:'ይህ መሣሪያ ለመሠረታዊ ስምምነቶች ብቻ ተዘጋጅቷል። እባክዎ ለ… ሕጋዊ ምክር የሕግ አማካሪ ያግኙ።',
    ...
    Government_tenders_or_regulated_industries:'የመንግስት ጨረታዎች ወይም ተደናቀፉ ኢንዱስትሪዎች',
    ...
    This_information_helps_us_pre_fill_your_contract:'ይህ መረጃ ውልዎን በቀድሞ ለመሙላት ይረዳናል።',
