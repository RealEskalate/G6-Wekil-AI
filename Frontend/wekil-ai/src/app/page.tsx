          ...
          <div className="container mx-auto flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight animate-fade-in-up">
                Create{" "}
                <span className="text-blue-600">Informal Agreements</span> in
                Seconds
              </h1>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-500">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Watch how Wekil AI transforms simple descriptions into
                      clear agreements.
                    </p>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm text-gray-700">
                      See real examples of agreements created with Wekil AI in
                      our{" "}
