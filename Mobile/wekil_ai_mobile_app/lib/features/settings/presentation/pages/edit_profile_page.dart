    ...
    return Scaffold(
      ...
      body: BlocConsumer<SettingBloc, SettingState>(
        ...
        builder: (context, state) {
          final bool loading =
              state is SettingLoading && !(state is ChangePasswordLoading);
                                ...
                                IconButton(
                                  onPressed: () async {
                                    ...
                                    if (currentState is SettingLoaded) {
                                      folder =
                                          'users/${currentState.profile.id}';
                                    }
                                    try {
                                      final uploader = di
                                          .sl<CloudinaryUploader>();
                              ...
                              onPressed: loading
                                  ...
                                  : () {
                                      if (_formKey.currentState?.validate() ??
                                          false) {
                                        final p = (state is SettingLoaded)
                                            ? state.profile
                                            : null;
                                        if (p == null) return;
